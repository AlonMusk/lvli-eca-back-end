<template>
  <div style="margin-top:20px;margin-left:10px;float: left ;">
    <el-form :inline="true" :model="tableData.searchParams" class="demo-form-inline">
      ...
      <el-form-item label="关键词搜索">
        <el-input v-model="tableData.searchParams.username" placeholder="请输入客户名" clearable />
      </el-form-item>
      <el-form-item>
  ...
  <div>
    <el-table ref="multipleTableRef" :data="tableData.list" style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column property="username" label="客户名称" width="" />
	     <el-table-column property="roleName" label="昵称" width="" />
		 		 <el-table-column property="roleName" label="手机号" width="" />
		 <el-table-column property="roleName" label="头像" width="" />
